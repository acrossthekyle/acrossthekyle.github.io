const data = [
  ...
  },
  {
    ...
    "notes": [
      "The River Ridge Backpack Trail at Forest Glen Preserve in Westville, Illinois, is a relatively moderate 10.5 mile loop designed for beginner backpackers, featuring steep ravines, creek crossings, and ridge-top hiking.",
      "It is widely considered one of the few true backpacking experiences in Illinois, often completed as an overnight trip with two dedicated primitive campsites."
    ],
    "position": [
      "49.5%",
      "19%"
  ...
  },
  {
    ...
    "notes": [
      "In Scotland there is an overland trek that extends for 97 miles from a town near Glasgow heading towards Fort William. This was one of the shorter thru-hikes I've done, taking only 6 days to complete it.",
  ...
  },
  {
    ...
    "notes": [
      "It had been a dream of mine for years to thru-hike the 'O' Circuit in Patagonia ever since my brief visit in 2016, and in 2020 I finally made it happen (just before COVID hit), and the trail did not disappoint.",
      "A tapestry of landscapes, sprawling glaciers, pristine lakes, and windswept plains provided an idyllic background for thru-hiking 73 miles over 8 days, with a pre-dawn hike up to the base of the 'Towers' being a perfect finale."
    ],
    "position": [
      "96%",
      "26%"
  ...
  },
  {
    ...
    "notes": [
      "A Northern Italian one-way thru-hike in the Dolomites mountain range on the Alta Via 1 trail, heading North to South. Total distance covered was 65 miles over 10 days, and elevation gains/losses were marginal at 25,109 ft (7,653 m) gained and 28,590 ft (8,714 m) respectively.",
  ...
  },
  {
    ...
    "notes": [
      "My second ever thru-hike that encircled a mountain called Mont Blanc in the European Alps. The trail is considered a classic long-distance hike and it took me 12 days over 106 miles (170 km) to complete it while passing through France, Italy, and Switzerland.",

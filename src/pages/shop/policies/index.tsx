    ...
    <View>
      ...
      <div className={styles.container}>
        ...
        <p>
          ...
          apply to ordering the wrong size, or simply changing your mind), I
          will gladly provide you with a one-time replacement without any
          additional fees after providing proof of damage/misprint. You must
          reach out within 14 days of product delivery. After 14 days no
          replacements will be provided.
        </p>
        <p>
          A printing partner (Printful) is used for the production and shipping
          of items.
        </p>
      </div>
    </View>

...
export default function Category({ colorMode, id, images, onClick }: Props) {
  return (
    <ul className={styles.grid}>
      {images
        .filter(({ category }) => category.toLowerCase() === id)
                ...
                >
                  <figure>
                    ...
                    <figcaption className={styles.caption}>
                      {image.collection.title} &mdash; {image.location.region}, {image.location.country}

...
export const useStoreIsEmpty = () => useStore((state) => getIsEmpty(state) && state.data.length === 0);
export const useStoreIsLoading = () => useStore((state) => getIsLoading(state));
export const useStoreIsReady = () => useStore((state) => getIsReady(state) && state.data.length > 0);

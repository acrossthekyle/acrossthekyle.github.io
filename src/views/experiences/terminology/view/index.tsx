...
export default function View() {
  ...
  return (
    <Layout group="experiences">
      ...
      <article className={styles.article(hash === 'thru-hike')}>
        <h2 id="thru-hike">
      ...
      <article className={styles.article(hash === 'section-hike')}>
        <h2 id="section-hike">
      ...
      <article className={styles.article(hash === 'overnight-trek')}>
        <h2 id="overnight-trek">
      ...
      <article className={styles.article(hash === 'peak-bagging')}>
        <h2 id="peak-bagging">
      ...
      <article className={styles.article(hash === 'vacation')}>
        <h2 id="vacation">

          ...
          <li>
            <ul className={styles.list}>
              <li>
                ...
                <ul>
                  <li className={styles.skill}>TNG breakdowns</li>
                </ul>
              </li>
              <li>
                <Link
                ...
                <ul>
                  <li className={styles.skill}>DS9, VOY, ENT breakdowns</li>
                </ul>
              </li>
              <li>
                <Link
                ...
                <ul>
                  <li className={styles.skill}>Everything Star Trek</li>
                </ul>
              </li>
            </ul>
          </li>
          <li>
            <ul className={styles.list}>
              <li>
                ...
                <ul>
                  <li className={styles.skill}>Movie/TV Series breakdowns</li>
                </ul>
              </li>
              <li>
                <Link
          ...
          <li>
            <ul className={styles.list}>
              <li>
                ...
                <ul>
                  <li className={styles.skill}>Gear reviews</li>
                </ul>
              </li>
              <li>
                <Link
                ...
                <ul>
                  <li className={styles.skill}>Backpacking advice</li>
                </ul>
              </li>
            </ul>
          </li>
          <li>
            <ul className={styles.list}>
              <li>
                <Link
                  className={styles.link}
                  href="https://www.youtube.com/@StarTalk/videos"
                  target="_blank"
                >
                  <ExternalIcon>Star Talk</ExternalIcon>
                </Link>
                <ul>
                  <li className={styles.skill}>Science, Physics, and more</li>
                </ul>
              </li>
            </ul>
          </li>
